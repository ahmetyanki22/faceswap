...
DIR_CONDA="$HOME/workspace/miniconda3"
CONDA_EXECUTABLE="${DIR_CONDA}/bin/conda"
CONDA_TO_PATH=false
ENV_NAME="faceswap"
PYENV_VERSION="3.10"

DIR_FACESWAP="$HOME/workspace/faceswap"
VERSION="nvidia"
...
post_install_opts() {
    ...
    if check_folder_exists "$HOME/workspace/Desktop" ; then
...
create_desktop_shortcut () {
    ...
    if $DESKTOP ; then
        desktop_icon="$HOME/workspace/Desktop/faceswap.desktop"
